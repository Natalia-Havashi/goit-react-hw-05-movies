...
import { Additional, GoBack, Information } from 'components/MovieDetails/MovieDetails.styled';
...
const MovieDetailsPage = () => {
  ...
  return (
    <div>
      ...
      <NavList>
        <NavItem>
          <Additional state={location.state} to="cast">Cast</Additional>
        </NavItem>
        <NavItem>
          <Additional state={location.state} to="reviews">Revies</Additional>
        </NavItem>
      </NavList>
